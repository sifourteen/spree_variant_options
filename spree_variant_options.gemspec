...
Gem::Specification.new do |s|
  ...
  s.add_dependency('spree_api', '~> 2.1.6')
  s.add_dependency('spree_frontend', '~> 2.1.6')
  s.add_dependency('spree_backend',  '~> 2.1.6')

  # Development
  s.add_development_dependency('spree_sample',     '~> 2.1.6')
